...
class MaxFlowImp {
    ...
    int n;
    private HashMap<Vertex, Integer> treeVertexIntergerHashMap = new HashMap<>();
    private Vertex[] treeVertexArr;
     ...
     * @param networkGraph
     */
    MaxFlowImp(DirectedWeightedMultigraph<Vertex, DefaultWeightedEdge> networkGraph) {
